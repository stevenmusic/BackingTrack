...
- **流行爵士的味道**：八分音符帶微搖擺、七和弦用無根音配置、貝斯每小節換走法
  （含走動低音）、和弦 comping 會切分
- **過門**：每一輪的最後一小節，預設只在最後一拍做個小句子，偶爾才擴成兩拍的大過門
- **不會整輪重播**：同一個伴奏樣式每小節都會有些微不同——多一顆大鼓、一記幽靈小鼓、
  hi-hat 空一格、貝斯在第三拍走五音或回根音。繞第二圈跟第一圈也不一樣
...
**微搖擺**。八分音符的後半拍落在 58% 而不是 50%。0.5 是完全平均、0.667 是標準爵士
三連音，58% 在中間偏平——聽得出律動，又不會變成大搖大擺的爵士。過門的十六分維持平均，
十六分也搖會糊成一團。

**無根音配置**。有七度或六度的和弦（四個音以上），右手不彈根音——低音已經有了。
...
**貝斯每小節換走法**，由小節號決定：A 根音—五音各撐兩拍（50%）、
B 帶一顆切分預備音（30%）、C 走動低音四個四分音符走「根—三—五—接音」（20%）。
三度取和弦自己寫的那個三度，不會在小調和弦上彈大三度。

**Comping 會切分**。四分打的第二、四拍有 45% 的機率往後挪到反拍，挪過去的那一下
稍微輕一點，像是順手帶過去的。
