...
| 和弦裡有什麼 | 感覺 | 效果 |
| --- | --- | --- |
| 九度以上的延伸音（`9` `11` `13` `alt`） | 搖擺 | swing 0.58、comping 稀疏、鼓輕、貝斯會走動 |
| 只有六度七度（`maj7` `m7` `7` `6`） | 拉丁 | 八分平均、鋼琴走 `1·二的後半·四`、小鼓當 rim click 打 clave、貝斯第三拍常提前半拍 |
| 只剩三和弦與掛留 | 直 | 八分平均、backbeat 紮實、根音—五音 |
...
現成的八組進行只順手把疏密調到合適的那一個（搖滾那兩組用「推進」，其餘用「打點」），
感覺仍然是和弦自己決定的。
